import{supabase as o}from"./supabase-BGxb2Nwl.js";import{r as n,m as v}from"./index-kkTdpkc5.js";const F=()=>{const c=n([]),i=n(!1),d=v(()=>i.value),u=async r=>{i.value=!0;try{const{data:s,error:e}=await o.from("wishes").insert([{...r,visibility:r.visibility||"friends",is_bought:!1,is_received:!1}]).select(`
          *,
